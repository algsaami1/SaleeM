...
"i686-linux-thread-multi-5.4.43-1-lts" or
	die "Errno architecture (i686-linux-thread-multi-5.4.43-1-lts) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
