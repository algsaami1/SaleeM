> **قاعدة v3.67 الناسخة لكل ما يتعارض معها:** صورة الشارت المرفوعة هي الخلفية النهائية الأصلية ولا تُعاد رسم شموعها. بيانات السوق تؤكد البنية والسيناريو فقط. يختار SaleeM سيناريو مرجعيًا واحدًا بعد التحقق الحتمي، ثم يرسم Educational Overlay نظيفًا فوق بكسلات الشارت نفسه. المرشح متقطع والمؤكد متصل، وEntry/Stop/TP لا تُرسم إلا عند معايرة محور السعر. المرجع التنفيذي: `SALEEM_EDUCATIONAL_OVERLAY_SPEC_V367.md`.
