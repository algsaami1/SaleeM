...
async def health():
    return {
        ...
        "memory": "read-only",
        "renderer": "saleem-m5-live-decision-v3.80.0",
        "ui": "saleem-m5-live-decision-ui-v3.80.0",
        ...
        "final_m5_refresh": "one forced M5 refresh per analysis",
        ...
        "live_decision_guard": "closed-structure+final-live-M5-gate+trigger-override+stale-page-guard",
