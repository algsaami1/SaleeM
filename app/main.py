...
async def health():
    return {
        ...
        "memory": "read-only",
        "renderer": "saleem-market-snapshot-axis-projection-v3.20.0",
        "ui": "saleem-unified-result-template-v3.20.0",
        ...
        "trade_mode": "single-primary-scenario+two-manual-distant-limit-plans",
        "targets": 3,
        "limit_recommendations": "manual-buy-limit-and-sell-limit-with-estimated-non-guaranteed-rates",
