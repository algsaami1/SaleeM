...
النتيجة النهائية سيعيد البرنامج رسمها داخل تصميم SaleeM. عند توفر image_axis_labels سيحسب البرنامج محور السعر الأيمن من أعلى رقم كامل والرقم الذي يليه مباشرة: الفرق بين السعرين هو price_step والفرق بين موضعيهما هو pixel_step، ثم يكرر الخطوة حتى أدنى رقم كامل في الصورة من دون إضافة رقم فوقه أو تحته. لذلك يجب أن تكون النقاط الثلاث دقيقة. يستخدم current_price والخط الحقيقي current_price_y_ratio للتحقق من موضع السعر الحالي، وتستخدم الشموع والدعم والمقاومة والدخول والوقف والأهداف التحويل الحسابي نفسه. لا يُستخدم الضبط التلقائي حول منطقة القرار إلا كحل احتياطي إذا تعذرت قراءة هذه النقاط الثلاث. تكون جهة الهدف أوسع قليلًا في وضع fallback فقط، وتظهر منطقة الربح باللون الأخضر ومنطقة الوقف باللون الأحمر. خطوط الدعم زرقاء فاتحة متصلة، وخطوط المقاومة بنفسجية متصلة، وخطوط TP خضراء متصلة. السهم يتبع الاتجاه الفعلي صعودًا أو هبوطًا ولا يكون صاعدًا افتراضيًا. يظهر Order Block كعنصر ثانوي فقط: أسفل السعر في السيناريو الصاعد أو أعلى السعر في السيناريو الهابط. ثم يرسم FVG وشريط الجلسات والدخول والوقف وثلاثة أهداف والملاحظات بوضوح.
