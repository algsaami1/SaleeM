...
5) image_axis_labels: قائمة أسعار محور الصورة نفسها من الأعلى إلى الأسفل. لكل عنصر أعد:
   ...
   أعد فقط الأرقام الظاهرة فعلًا وبشكل كامل على محور الصورة من الأعلى إلى الأسفل، ويفضل أكبر عدد ممكن بين 6 و14 قيمة متتالية إن أمكن. ممنوع استنتاج رقم قبل أول رقم ظاهر أو بعد آخر رقم ظاهر، وممنوع إكمال السلسلة حسابيًا. إذا كان الرقم عند الحافة مقصوصًا أو غير واضح فلا تُعده. إذا ظهرت سلسلة متتابعة من الأرقام فحافظ عليها كاملة ولا تتخطَّ بينها إلا إذا كان الرقم غير واضح.
